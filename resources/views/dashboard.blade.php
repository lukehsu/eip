...
<div class="container-fluid">
  @include('includes.navbar')
	<div class="row">
    	<div class="col-md-9" >
      		<div class="tabset0">
         		<div data-pws-tab="tab1" data-pws-tab-name="資訊需求單" >
         		...
         		<div  data-pws-tab="tab2" data-pws-tab-name="資訊" >
					<div class="row" style="height:30px">
    					<div class="col-md-1">
							<h2 >項目</h2>
    					</div>
					...
					<div class="row">
    					<div class="col-md-12" style="background-color:#95A5A6"></div>			
					</div>
						{!!$itservice!!}
					<div class="row">
    					<div class="col-md-12" style="margin-top:8px;background-color:#95A5A6"></div>			
					</div>
         		</div>
      		</div>
		</div>
