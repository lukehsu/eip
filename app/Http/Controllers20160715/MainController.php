...
class MainController extends Controller {
  ...
  */
  ...
  public function gpgo()
  {
    ...
    $shippingbig = '物流';
    #撈在職人員for view
    $users = DB::table('userstatesgps')->where('exist','=','在職')->where('userstatus','=',$usergroup)->orderBy('sortstand','asc')->get();
    foreach ($users as $user) {
    ...
    $productssell   = FController::productssell($medvalue,$choicedaymed,$monthstartmed,$usergroup,$medaccess,$allitems);
    $producbudget   = FController::productsbudget($medvalue,$choicedaymed,$monthstartmed,$usergroup,$medaccess);
    $productab = [];
    ...
    $productssellQ   = FController::productssellQ($medvalue,$choicedaymed,$monthstartmed,$usergroup,$medaccess,$allitems);
    $productsbudgetQ = FController::productsbudgetQ($medvalue,$choicedaymed,$monthstartmed,$usergroup,$medaccess);
    $productQab = [];
    ...
    $yearach = FController::yearach($medvalue,$choicedaymed,$monthstartmed,$usergroup,$medaccess,$allitems);
